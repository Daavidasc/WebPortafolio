export const profile = {
  ...
  projects: {
    ...
    items: [
      {
        id: 'project-urpi-pyme',
        name: 'Urpi - Plataforma inteligente para PYMES',
        year: '2026',
        category: 'Software / Datos / Hackathon',
        status: '[MVP presentado]',
        image: '/images/projects/project-reference-grid.png',
        alt: 'Referencia visual para proyecto Urpi',
      },
      {
        id: 'project-nasa-exoplanetas',
        name: 'Deteccion de exoplanetas con datos NASA',
        year: '2025',
        category: 'Machine Learning / Data Science',
        status: '[MVP en hackathon]',
        image: '/images/projects/project-placeholder-screen.png',
        alt: 'Referencia visual para proyecto de deteccion de exoplanetas',
      },
      {
        id: 'project-ejercito-modulos-internos',
        name: 'Modulos internos full stack',
        year: '2026',
        category: 'Full Stack / Sistemas internos',
        status: '[En desarrollo]',
        image: '/images/projects/project-reference-grid.png',
        alt: 'Referencia visual para modulos internos full stack',
      },
    ],
  },
  experience: {
