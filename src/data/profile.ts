export const profile = {
  ...
  projects: {
    ...
    summary:
      'Seleccion de proyectos y desarrollos tecnicos basados en experiencia academica, hackathons y practica profesional.',
    items: [
      {
        id: 'project-emotiongestureapp',
        name: 'EmotionGestureApp',
        year: '2025',
        category: 'Computer Vision / IA',
        status: 'MVP',
        image: '/images/projects/project-reference-grid.png',
        alt: 'Proyecto EmotionGestureApp para detección de gestos y emociones',
        description:
          'Aplicación de visión artificial en tiempo real para la interacción hombre-máquina mediante detección de gestos y emociones.',
        href: 'https://github.com/Daavidasc/EmotionGestureApp',
      },
      {
        id: 'project-viviestu',
        name: 'ViviEstu',
        year: '2025',
        category: 'Full Stack / Arquitectura',
        status: 'Plataforma MVP',
        image: '/images/projects/project-placeholder-screen.png',
        alt: 'Proyecto ViviEstu para arrendamiento universitario',
        description:
          'Plataforma Fullstack para conectar estudiantes con arrendadores, centralizando información y reforzando la seguridad en la búsqueda de vivienda.',
      },
      {
        id: 'project-keplerx',
        name: 'KeplerX',
        ...
        status: 'API + Docker',
        image: '/images/projects/project-reference-grid.png',
        alt: 'Proyecto KeplerX para detección de exoplanetas',
        description:
          'Sistema integral para identificar exoplanetas a partir de datos astronómicos abiertos de la NASA, combinando análisis estadístico, Machine Learning y despliegue reproducible.',
        href: 'https://github.com/Machiz/KeplerX',
      },
    ],
  },
  experience: {
